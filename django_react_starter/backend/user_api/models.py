...
class User(AbstractUser):
    ...
    table_theme = models.TextField(max_length=500, choices=TABLE_THEME_CHOICES, default="blue")
    card_backing = models.TextField(max_length=500, choices=CARD_BACKING_CHOICES, default="blue")
